...
<template>
	<form class="cv-form-b" @submit.prevent>
		...
		<div class="grid">
			...
			<label>Backend 2<input :value="modelValue.skills.backend[1].label" @input="updateCV('skills.backend.0.label', $event.target.value)" /></label>
			<label>Backend 2 ghi chú<input :value="modelValue.skills.backend[1].note" @input="updateCV('skills.backend.0.note', $event.target.value)" /></label>
...
.cv-form-b :is(input, textarea)::placeholder { color: #8a98a6; }
