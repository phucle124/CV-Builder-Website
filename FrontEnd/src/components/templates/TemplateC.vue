...
<template>
  <div class="page">
    <div class="card">
      <div class="left">
        ...
        <section class="skills">
          ...
          <div class="skill-block">
            ...
            <div class="chips">
              <span v-for="(s,i) in d.skills.backend" :key="'b'+i" class="chip">{{ s.label }} ({{ s.note }})</span>
            </div>
          </div>
          <div class="skill-block">
            <div class="label">Front-end</div>
            <div class="chips">
              <span v-for="(s,i) in d.skills.frontend" :key="'f'+i" class="chip">{{ s.label }} ({{ s.note }})</span>
            </div>
          </div>
          <div class="skill-block soft">
            <div class="label">Soft Skills</div>
            <ul>
              <li v-for="(s,i) in d.skills.soft" :key="'s'+i">{{ s }}</li>
            </ul>
          </div>
        </section>
      ...
      <aside>
        ...
        <div class="section" v-if="d.languages">
          ...
          <div class="lang" v-for="(l,i) in d.languages" :key="i">{{ l }}</div>
        </div>

        <div class="section" v-if="d.awards">
    ...
    <div class="page-num">Page 1/2 — © itViec.com</div>
  </div>
</template>
