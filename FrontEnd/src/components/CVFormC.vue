...
<template>
  <form class="cv-form" @submit.prevent>
    ...
    <div class="grid">
      ...
      <label>Thời gian<input :value="modelValue.certificates[0].date" @input="updateCV('certificates.0.date', $event.target.value)" /></label>
    ...
    <h2>Giải thưởng</h2>
    <div class="grid">
      <label>Tên giải<input :value="modelValue.awards[0].name" @input="updateCV('awards.0.name', $event.target.value)" /></label>
      <label>Tổ chức<input :value="modelValue.awards[0].org" @input="updateCV('awards.0.org', $event.target.value)" /></label>
      <label>Năm<input :value="modelValue.awards[0].year" @input="updateCV('awards.0.year', $event.target.value)" /></label>
    </div>
